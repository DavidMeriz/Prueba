      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
            <a class="sidebar-link" href="autores/autores.php" target="base" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
            <a class="sidebar-link" href="publicaciones/publicaciones.php" target="base" aria-expanded="false">
                <span>
                  <i class="ti ti-alert-circle"></i>
                </span>
