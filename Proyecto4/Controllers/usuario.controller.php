...
switch ($_GET["op"]) {
    case 'todos':
        ...
        break;
    case "uno":
        $ID = $_POST["ID"]; //defino una variable para almacenar el id del usuario, la variable se obtiene mediante POST
        $datos = array(); //defino un arreglo
        $datos = $usuarios->uno($ID); //llamo al modelo de usuarios e invoco al procedimiento uno y almaceno en una variable
    ...
    case 'actualizar':
        ...
        $datos = array(); //defino un arreglo
        $datos = $usuarios->actualizar($ID, $Cedula, $Nombres, $Apellidos, $Telefono, $Correo, $Contrasenia, $Rol); //llamo al modelo de usuarios e invoco al procedimiento actual
        echo json_encode($datos); //devuelvo el arreglo en formato json
        break;
    case 'eliminar':
        $ID = $_POST["ID"]; //defino una variable para almacenar el id del usuario, la variable se obtiene mediante POST
        $datos = array(); //defino un arreglo
        $datos = $usuarios->eliminar($ID); //llamo al modelo de usuarios e invoco al procedimiento uno y almaceno en una variable
        echo json_encode($datos); //devuelvo el arreglo en formato json
        break;
    case 'actualizar_contrasenia':
        ...
        $Contrasenia = $_POST["Contrasenia"];
        $datos = array(); //defino un arreglo
        $datos = $usuarios->actualizar_contrasenia($ID, $Contrasenia); //llamo al modelo de usuarios e invoco al procedimiento actual
